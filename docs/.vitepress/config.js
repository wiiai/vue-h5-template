...
module.exports = {
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/wiiai/vue-h5-template' }],
    editLink: {
      pattern: 'https://github.com/wiiai/vue-h5-template/blob/docs/docs/:path',
      text: '在GitHub编辑此页',
    },
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright © 2022-present wiiai',
    },
    algolia: {
      appId: 'CV2I8NGBKZ',
